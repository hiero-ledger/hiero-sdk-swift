...
internal final class TransactionRecordUnitTests: HieroUnitTestCase {
    ...
    private func createRecord(_ prngBytes: Data?, _ prngNumber: UInt32?) throws -> TransactionRecord {
        try TransactionRecord.init(
            ...
            aliasKey: TestConstants.publicKey,
            children: [],
            duplicates: [],
    ...
    internal func test_Serialize() throws {
        ...
        SnapshotTesting.assertSnapshot(of: record, as: .description)
    }
