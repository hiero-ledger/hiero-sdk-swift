...
internal final class TransferTransactionUnitTests: HieroUnitTestCase, TransactionTestable {
    typealias TransactionType = TransferTransaction

    static func makeTransaction() throws -> TransferTransaction {
    ...
    internal func test_GetDecimals() {
        let tx = TransferTransaction()
