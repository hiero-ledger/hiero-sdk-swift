...
public final class RlpUnitTests: HieroUnitTestCase {
    ...
    internal func test_EncodeEmptyString() {
        encodeTest(RlpTestCases.emptyString)
    }

    internal func test_EncodeByteString00() {
        encodeTest(RlpTestCases.bytestring00)
    }

    internal func test_EncodeByteString01() {
        encodeTest(RlpTestCases.bytestring01)
    }

    internal func test_EncodeByteString7F() {
        encodeTest(RlpTestCases.bytestring7F)
    }

    internal func test_EncodeShortString() {
        encodeTest(RlpTestCases.shortstring)
    }

    internal func test_EncodeShortString2() {
        encodeTest(RlpTestCases.shortstring2)
    }

    internal func test_EncodeLongString() {
        encodeTest(RlpTestCases.longstring)
    }

    internal func test_EncodeLongString2() {
        encodeTest(RlpTestCases.longstring2)
    }

    internal func test_EncodeEmptyList() {
        encodeTest(RlpTestCases.emptylist)
    }

    internal func test_EncodeStringList() {
        encodeTest(RlpTestCases.stringlist)
    }

    internal func test_EncodeShortListMax1() {
        encodeTest(RlpTestCases.shortListMax1)
    }

    internal func test_EncodeLongList1() {
        encodeTest(RlpTestCases.longList1)
    }

    internal func test_EncodeLongList2() {
        encodeTest(RlpTestCases.longList2)
    }

    internal func test_EncodeListsOfLists() {
        encodeTest(RlpTestCases.listsoflists)
    }

    internal func test_EncodeListsOfLists2() {
        encodeTest(RlpTestCases.listsoflists2)
    }

    internal func test_EncodeDictTest1() {
        encodeTest(RlpTestCases.dictTest1)
    }

    internal func test_DecodeEmptyString() throws {
        try decodeTest(RlpTestCases.emptyString)
    }

    internal func test_DecodeByteString00() throws {
        try decodeTest(RlpTestCases.bytestring00)
    }

    internal func test_DecodeByteString01() throws {
        try decodeTest(RlpTestCases.bytestring01)
    }

    internal func test_DecodeByteString7F() throws {
        try decodeTest(RlpTestCases.bytestring7F)
    }

    internal func test_DecodeShortString() throws {
        try decodeTest(RlpTestCases.shortstring)
    }

    internal func test_DecodeShortString2() throws {
        try decodeTest(RlpTestCases.shortstring2)
    }

    internal func test_DecodeLongString() throws {
        try decodeTest(RlpTestCases.longstring)
    }

    internal func test_DecodeLongString2() throws {
        try decodeTest(RlpTestCases.longstring2)
    }

    internal func test_DecodeEmptyList() throws {
        try decodeTest(RlpTestCases.emptylist)
    }

    internal func test_DecodeStringList() throws {
        try decodeTest(RlpTestCases.stringlist)
    }

    internal func test_DecodeShortListMax1() throws {
        try decodeTest(RlpTestCases.shortListMax1)
    }

    internal func test_DecodeLongList1() throws {
        try decodeTest(RlpTestCases.longList1)
    }

    internal func test_DecodeLongList2() throws {
        try decodeTest(RlpTestCases.longList2)
    }

    internal func test_DecodeListsOfLists() throws {
        try decodeTest(RlpTestCases.listsoflists)
    }

    internal func test_DecodeListsOfLists2() throws {
        try decodeTest(RlpTestCases.listsoflists2)
    }

    internal func test_DecodeDictTest1() throws {
