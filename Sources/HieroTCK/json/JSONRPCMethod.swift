...
internal enum JSONRPCMethod: String {
    ...
    case contractByteCodeQuery = "contractByteCodeQuery"
    case contractCallQuery = "contractCallQuery"
    case contractInfoQuery = "contractInfoQuery"
    case createContract = "createContract"
    case createEthereumTransaction = "createEthereumTransaction"
    ...
    case deleteContract = "deleteContract"
    ...
    case updateContract = "updateContract"
