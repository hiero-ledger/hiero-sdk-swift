...
internal final class MirrorNodeContractQueryUnitTests: HieroUnitTestCase {
    ...
    internal func test_GetSetContractEvmAddress() throws {
        let query = MirrorNodeContractEstimateGasQuery()
    ...
    internal func test_GetSetSender() {
        let query = MirrorNodeContractEstimateGasQuery()
    ...
    internal func test_GetSetSenderEvmAddress() throws {
        let query = MirrorNodeContractEstimateGasQuery()
    ...
    internal func test_SetFunction() {
        let query = MirrorNodeContractEstimateGasQuery()
    ...
    internal func test_GetSetGasPrice() {
        let query = MirrorNodeContractEstimateGasQuery()
    ...
    internal func test_GetSetBlockNumber() {
        let query = MirrorNodeContractEstimateGasQuery()
