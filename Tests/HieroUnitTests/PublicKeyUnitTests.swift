...
internal final class PublicKeyUnitTests: HieroUnitTestCase {
    ...
    internal func test_ToEvmAddress2() throws {
    ...
    internal func test_Ed25519Verify() throws {
    ...
    internal func test_EcdsaVerify() throws {
        let publicKey = try PublicKey.fromStringDer(
            "302d300706052b8104000a03220002703a9370b0443be6ae7c507b0aec81a55e94e4a863b9655360bd65358caa6588"
        )
    ...
    internal func test_Ed25519VerifyErrorEcdsa() throws {
        let publicKey = try PublicKey.fromStringDer(
            "302a300506032b6570032100e0c8ec2758a5879ffac226a13c0c516b799e72e35141a0dd828f94d37988a4b7"
        )
    ...
    internal func test_EcdsaVerifyErrorEd25519() throws {
        let publicKey = try PublicKey.fromStringDer(
            "302d300706052b8104000a03220002703a9370b0443be6ae7c507b0aec81a55e94e4a863b9655360bd65358caa6588"
        )
    ...
    internal func test_K256CompressedPkcs8EcSpkiDer() throws {
    ...
    internal func test_K256UncompressedPkcs8EcSpkiDer() throws {
        let pk = try PublicKey.fromString(
