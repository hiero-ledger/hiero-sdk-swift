...
internal final class PrivateKeyUnitTests: HieroUnitTestCase {
    internal func test_ParseEd25519() throws {
    ...
    internal func test_ParseEd25519WithPublicKey() throws {
    ...
    internal func test_ParseEcdsa() throws {
        let privateKey: PrivateKey =
    ...
    internal func test_Ed25519Sign() throws {
    ...
    internal func test_EcdsaSign() throws {
        let privateKey: PrivateKey =
            "3030020100300706052b8104000a042204208776c6b831a1b61ac10dac0304a2843de4716f54b1919bb91a2685d0fe3f3048"
    ...
    internal func test_Ed25519LegacyDerive() throws {
        let privateKey: PrivateKey =
            "302e020100300506032b65700422042098aa82d6125b5efa04bf8372be7931d05cd77f5ef3330b97d6ee7c006eaaf312"
    ...
    internal func test_Ed25519LegacyDerive2() throws {
        let privateKey: PrivateKey =
    ...
    // "iosKey"
    internal func test_Ed25519Derive1() throws {
    ...
    // "androidKey"
    internal func test_Ed25519Derive2() throws {
        let key = keyWithChain(
            key:
    ...
    internal func test_Ed25519FromPem() throws {
        let pemString = """
            -----BEGIN PRIVATE KEY-----
    ...
    internal func test_Ed25519FromPemWithPassword() throws {
        let pemString =
            """
    ...
    internal func test_EcdsaFromPem() throws {
        let pemString = """
            -----BEGIN PRIVATE KEY-----
    ...
    internal func test_Ed25519FromPemInvalidTypeLabel() {
    ...
    internal func test_Ed25519Pkcs8UnencryptedPem() throws {
        let s = """
            -----BEGIN PRIVATE KEY-----
    ...
    internal func test_EcdsaEcUnencryptedUncompressedPem() throws {
        let s = """
    ...
    internal func test_EcdsaEcUnencryptedCompressedPem() throws {
        let s = """
            -----BEGIN EC PRIVATE KEY-----
    ...
    internal func test_Ed25519Pkcs8EncryptedPem() throws {
        let s = """
            -----BEGIN ENCRYPTED PRIVATE KEY-----
    ...
    internal func test_EcdsaEcEncryptedUncompressedPem() throws {
        let s = """
            -----BEGIN EC PRIVATE KEY-----
    ...
    internal func test_EcdsaEcEncryptedCompressedPem() throws {
        let s = """
            -----BEGIN EC PRIVATE KEY-----
            Proc-Type: 4,ENCRYPTED
    ...
    internal func test_Ed25519Pkcs8DerPrivateKey() throws {
    ...
    internal func test_EcdsaEcPrivateKeyCompressedDer() throws {
        let s =
    ...
    internal func test_EcdsaEcPrivateKeyUncompressedDer() throws {
        let s =
    ...
    internal func test_EcdsaEcPrivateKeyNoPublicKeyDer() throws {
    ...
    internal func test_slip10TestVector1() throws {
