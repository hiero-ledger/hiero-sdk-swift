...
internal final class MnemonicUnitTests: HieroUnitTestCase {
    ...
    internal func test_InvalidLengthError() {
    ...
    internal func test_UnknownWords1() {
    ...
    internal func test_UnknownWords2() {
    ...
    internal func test_ChecksumMismatch1() {
        let mnemonic =
    ...
    internal func test_ChecksumMismatch2() {
    ...
    internal func test_FromEntropy() throws {
        let entropy = [
    ...
    internal func test_Mnemonic3() throws {
        let str =
    ...
    internal func test_LegacyMnemonic() throws {
        let str =
    ...
    internal func test_ToPrivateKey() throws {
        let str =
    ...
    internal func test_ToStandardECDSAsecp256k1PrivateKey() throws {
    ...
    internal func test_ToStandardECDSAsecp256k1PrivateKey2() throws {
