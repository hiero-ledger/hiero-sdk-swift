...
internal final class EntityIdUnitTests: HieroUnitTestCase {
    internal func test_ChecksumOnMainnet() {
        let expected: [String] = [
    ...
    internal func test_ChecksumOnTestnet() {
        let expected: [String] = [
    ...
    internal func test_AccountIdChecksum() throws {
    ...
    internal func test_ChecksumOnPreviewnet() {
        let expected: [String] = [
    ...
    internal func test_ChecksumOnCustomNetwork() {
        let expected: [String] = [
