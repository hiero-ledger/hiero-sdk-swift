...
internal final class ContractFunctionResultUnitTests: HieroUnitTestCase {
    internal func test_GetUInt8() {
    ...
    internal func test_ProvidesResults() {
    ...
    internal func test_StringArrayResults() {
    ...
    internal func test_StringArrayResults2() {
    ...
    internal func test_IndexOOBNoCrash() {
