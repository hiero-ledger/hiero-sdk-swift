...
internal final class TokenRevokeKycTransactionUnitTests: HieroUnitTestCase, TransactionTestable {
    typealias TransactionType = TokenRevokeKycTransaction

    internal static let testAccountId: AccountId = "6.9.0"

    internal static let testTokenId: TokenId = "4.2.0"

    static func makeTransaction() throws -> TokenRevokeKycTransaction {
