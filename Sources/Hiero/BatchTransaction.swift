...
public final class BatchTransaction: Transaction {
     ...
     */
    @discardableResult
    public func transactions(_ transactions: [Transaction]) -> Self {
     ...
     */
    @discardableResult
    public func addTransaction(_ transaction: Transaction) -> Self {
...
extension BatchTransaction: ToProtobuf {
    ...
    internal func toProtobuf() -> Protobuf {
        return try! .with { proto in
            proto.transactions = try Transaction.toProtoTransactions(transactions)
        }
    }
}
