...
internal final class NodeUpdateTransactionUnitTests: HieroUnitTestCase, TransactionTestable {
    typealias TransactionType = NodeUpdateTransaction
    ...
    static func makeTransaction() throws -> NodeUpdateTransaction {
